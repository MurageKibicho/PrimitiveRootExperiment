...
//clear && gcc 1.7.DeltaSum.c -lm -lgmp -lmpfr -lflint -o m.o && ./m.o
...
void BenchMarkLSB()
{
	...
	{
		fmpz_set_ui(privateKey, i);
		LSBScalarMultiplication(result0, generator, privateKey, primeNumber);	
		LSBCachedMultiplication(bitCount, cachedDoubles, result1, generator, privateKey, primeNumber);
		assert(TestPointEquality(result0, result1));
		//PrintPoint(result0);
		//PrintPoint(result1);
		//printf("\n\n");
	}
...
/*
68073332634951771983379810576461367518612914887001815873609470706324019594353 100265349306802633132698962749090572900634375768193967970766835776642803928888
